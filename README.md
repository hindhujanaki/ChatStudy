...
while True:
 while(i<len(l)):
       ...
       if ack:
           ...
           i+=s
##  Output:
![image](https://github.com/hindhujanaki/ChatStudy/assets/148514666/b4a0d2e3-7abf-4088-bd4d-607f4b9a6236)
## Server:
import socket
s=socket.socket()
...
while True: 
 ...
 ## Output:
 ![image](https://github.com/hindhujanaki/ChatStudy/assets/148514666/4a3cf1e1-5bec-425d-be1c-f02926ae5102)
